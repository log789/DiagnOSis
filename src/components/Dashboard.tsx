      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
        ...
        <div className="lg:col-span-2 space-y-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div className="bg-white rounded-[40px] p-10 shadow-card border border-slate-100 flex flex-col items-center justify-center text-center group hover:border-accent/20 transition-all duration-500">
              <div className="w-24 h-24 rounded-full border-[6px] border-slate-50 flex items-center justify-center relative mb-6">
                <div className="absolute inset-0 rounded-full border-[6px] border-accent border-t-transparent -rotate-45 group-hover:rotate-0 transition-transform duration-1000" />
              ...
              <p className="text-sm text-slate-500 font-medium mb-6">Based on recent memory training</p>
              <button className="px-6 py-3 bg-slate-50 text-slate-600 rounded-2xl text-xs font-bold hover:bg-accent hover:text-white transition-all duration-300">
                View History
              </button>
            </div>
          </div>
